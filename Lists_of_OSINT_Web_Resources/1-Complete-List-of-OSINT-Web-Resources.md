...
- [GigaPan](http://www.gigapan.com/)  
  Provides hardware, software, and services to create and share high-resolution, interactive gigapixel panoramic images.
...
- [FotoFlexer](https://fotoflexer.com/editor/)  
...
- [RadioGarden](http://radio.garden/)  
  Tune into thousands of live radio stations from across the world.
- [Live Online Radio](https://liveonlineradio.net/)  
  A large directory of radio stations from around the world that lets you listen in. Organized by geographical region.
- [RadioNet](https://www.radio.net/local-stations)  
  View and listen to radio stations near your location or search for radio stations via keyword.
- [Broadcastify](https://www.broadcastify.com/listen/)  
  Listen to live to police, fire, EMS, aviation, and rail audio feeds from the USA.
- [Radiooooo](https://radiooooo.com/)  
  A collaborative collection of radio stations from all over the world.
- [OpenMHz](https://openmhz.com/)  
  Listen to live police and fire radio from all across the U.S.
- [RadioReference](https://www.radioreference.com/)  
  The largest radio communications data provider. Has a complete frequency database, trunked radio system information and FCC license data. Requires registration.
- [American Archive of Public Broadcasting](https://americanarchive.org/)  
  Discover, listen and watch historic radio and television broadcasts from across the USA.
- [GlobalTuners](https://www.globaltuners.com/)  
  Provides access to remotely controlled radio receivers all over the world. You can tune the receivers to listen to remote radio broadcasts, air traffic, amateur transmissions and much more.
- [Wide-Band WebSDR](http://websdr.ewi.utwente.nl:8901/)  
  On this page you can listen to and control a short-wave receiver located at the amateur radio club at the University of Twente. This receiver can be tuned by multiple users simultaneously.
- [Digital Frequency Search](https://digitalfrequencysearch.com/index.php)  
  Helps find, scan, and identify digital radio frequencies in a specific area. All searches are by county and state. Data is provided from the FCC.
- [DXing](https://www.dxing.com/scanfreq.htm)  
  A database of national radio frequencies.
- [American Disaster Shortwave Frequencies](http://www.nat-com.org/swfreq.htm)  
  A list of emergency radio frequencies used by various US agencies.
- [Bearcat Family Radio Frequencies](http://www.bearcat1.com/family.htm)  
  A list of radio frequencies used by [NatCom](http://www.nat-com.org/).
- [Bearcat Fast Food Frequencies](http://www.bearcat1.com/fastfood.htm)  
  A list of frequencies used by fast food chains in the US.
- [Bearcat Military Frequencies](http://www.bearcat1.com/feds.htm)  
  A list of US military trunked radio frequencies.
- [Bearcat Sports Frequencies](http://www.bearcat1.com/sports.htm)  
  A list of radio frequencies related to sports.
- [Bearcat Online](http://www.bearcat1.com/subscription.htm)  
...
- [SteamCommunity](https://steamcommunity.com/discussions/)  
  A massive gaming forum and discussion board for the Steam community.
- [GameFAQ](https://gamefaqs.gamespot.com/boards)  
  One of the largest online gaming forums. Tips, tricks, guides and user discussions.
- [IGN Boards](https://www.ignboards.com/)  
  Large gaming forum. Includes user discussions, guides, news and more.
- [NeoGaf](https://www.neogaf.com/)  
  Another online gaming forum.
- [GTAinside](https://www.gtainside.com/en/news.php)  
  Grand Theft Auto mods and modding community.

## **Steam**

- [SteamID](https://steamid.uk/)  
  A service where you can easily find information on Steam profiles. Simply enter a user’s Steam ID or profile URL and you will be shown historical information such as the user’s previously used avatars, aliases, historic friends and game information. 
- [SteamSpy](https://steamspy.com/)  
  Gathers data from Steam user profiles, analyzes it and presents it in a neatly organized fashion.
- [SteamDB](https://steamdb.info/calculator/)  
  Shows how much money a user has spent on Steam games.
- [SteamRep](https://steamrep.com/)  
  A tool to search a Steam account to see any reports of scamming related to that account.
- [STEAMID/IO](https://steamid.io/)  
  Convert Steam IDs, Steam ID64s, Steam ID3s, Custom URLs and find Steam Community profiles.
- [Steam ID Finder](https://www.steamidfinder.com/)  
  Similar to the above. Allows you to covert SteamIDs and find the associated account.
- [FindSteamID](https://findsteamid.com/en/home)  
  Another tool for searching SteamIDs.
- [SteamDiscovery](https://www.steamdiscovery.com/)  
  A tool that helps you filter the best Steam games by genre, tags, keywords and more. With Steam games sales tracking and updated guides for every Steam game.

## **Xbox Live and PlayStation Network**

- [XboxGamertag](https://xboxgamertag.com)  
  Lookup a Xbox Live gamertag and see information about their profile including name, gamerscore, achievements, profile picture, avatar, bio and more. Works for both Xbox 360 and Xbox One accounts.
- [Tracker.gg](https://tracker.gg/)  
  Enter a Xbox gamertag, PSN name or user ID to find player stats for a large variety of games.
- [PSNProfiles](https://psnprofiles.com/)  
  Look up a PSN username and view that players stats, profile picture, recently played games and trophies.
- [PSN Trophy Leaders](https://psntrophyleaders.com/)  
  View PSN trophy leaderboards and profile information such as profile picture, played games, statistics and more.

## **Game Specific**

- [Rolimons](https://www.rolimons.com/players)  
  Quickly search for Roblox players and view their profiles. Show which limited items they own, their RAP, value charts, and more.     
- [Minecraft-Statistics](https://minecraft-statistic.net/en/players/)  
  Displays detailed statistics for Minecraft players. You can find the players by nickname or UUID. See which servers they played in, how much time they spent on each server, when they last played, how many hours a day they play, with whom last played and more.
- [MinecraftUUID](https://minecraftuuid.com/)  
...
- [UCSF Industry Documents](https://industrydocuments.ucsf.edu/)  
...
- [LuminDatabase](https://www.lumendatabase.org/)  
...
- [CensoredPlanet](https://censoredplanet.org/)  
...
- [FBI Vault](https://vault.fbi.gov/search)  
...
- [US Department of State Records](https://foia.state.gov/)  
...
- [Australian National Archives Search](https://recordsearch.naa.gov.au/SearchNRetrieve/Interface/SearchScreens/BasicSearch.aspx)  
...
- [WWF](https://www.worldwildlife.org/)  
  The World Wide Fund for Nature is an international non-governmental organization founded in 1961 that works in the field of wilderness and wildlife preservation and the reduction of human impact on the environment.
...
- [EmmeLine Conflict Map](https://emmeline.carto.com/viz/b69015da-136a-11e5-a64a-0e43f3deba5a/public_map)  
  A map of all major active conflicts across the globe. Click on a crisis to learn more. 
- [RiskMap](https://riskmap.com)  
  A free security and risk mapping platform for viewing and analyzing global security threats in real-time. Requires registration for full access.
- [Global Threat Assessment Map](https://cicentre.com/general/custom.asp?page=global_threatmap)  
  This map contains a threat assessment of key countries as well as the current political climate. Updated every week.
- [Mapping Militants](https://cisac.fsi.stanford.edu/mappingmilitants)  
  An interactive map that identifies patterns in the evolution of militant organizations in specified conflict theatres and provides representations of changing relationships among groups. 
- [The Homicide Monitor](https://homicide.igarape.org.br/)  
  An interactive map of the most comprehensive publicly available dataset on murder rates in the world.
- [ConflictID](https://conflict.id/home)  
...
- [Milsurp Knowledge Library](http://www.milsurps.com/content.php)  
...
- [FirearmsGuide](https://www.firearmsguide.com/)  
...
- [Municion](https://municion.org/buscador/)  
...
- [Wikipedia - List of Landmines](https://en.wikipedia.org/wiki/List_of_land_mines) ([WikiLess](https://wikiless.org/wiki/List_of_land_mines))  
...
- [[PDF] Worldwide Equipment Identification Cards - Iran](https://fas.org/irp/doddir/army/id-iran.pdf)  
  Visual equipment identification guide for Iran. Archived copies available [here (Wayback)](https://web.archive.org/web/20211020015449/https://irp.fas.org/doddir/army/id-iran.pdf) and [here (Library Genesis)](https://libgen.is/book/index.php?md5=F413F6891A1CF0C7CCEE8C159E384EBD).
- [[PDF] Worldwide Equipment Identification Cards - Russia](https://fas.org/irp/doddir/army/id-russia.pdf)  
  Visual equipment identification guide for Russia. Archived copies available [here (Wayback)](https://web.archive.org/web/20211020012301/https://irp.fas.org/doddir/army/id-russia.pdf) and [here (Library Genesis)](https://libgen.is/book/index.php?md5=255C13FBC893B682F9FF7231628AB019).
- [[PDF] Worldwide Equipment Identification Cards - China](https://fas.org/irp/doddir/army/id-china.pdf)  
  Visual equipment identification guide for China. Archived copies available [here (Wayback)](https://web.archive.org/web/20211019220701/https://irp.fas.org/doddir/army/id-china.pdf) and [here (Library Genesis)](https://libgen.is/book/index.php?md5=A90F39D544447DE6C036F442B13AA7C8).
- [[IMAGE] US Combat Vehicles Infographic](https://www.offgridweb.com/wp-content/uploads/2016/05/Military-vehicles-guide-1.jpg)  
  Quick visual reference for US military vehicles. Archived [here (Wayback)](https://web.archive.org/web/20211019091334/https://www.offgridweb.com/wp-content/uploads/2016/05/Military-vehicles-guide-1.jpg) and [here (archive.today)](https://archive.ph/vMMFI/3e09335b7062a22bb09ba09f349d4b1db762ee80.jpg).
- [[PDF] Worldwide Equipment Guide - 1999](https://fas.org/man/dod-101/sys/land/row/weg.pdf)  
  Visual reference guide for common equipment with notes and technical information. Archived [here (Wayback)](https://web.archive.org/web/20211020004238/https://man.fas.org/dod-101/sys/land/row/weg.pdf) and [here (Library Genesis)](http://libgen.rs/book/index.php?md5=B6DBF1D98E3BB079BB30AFE18342398D).
- [ArmyRecognition](https://www.armyrecognition.com/individual_page/world_military_equipment.html)  
  A neatly organized directory of vehicles and equipment used by various militaries from all over the world.
- [Anatomy of a Tank](https://ag.hyperxgaming.com/article/5256/anatomy-of-a-tank-in-world-of-tanks)  
  Learn how to identify the main external parts of a tank. This is actually from a video game called "World of Tanks", and it's awesome.
- [Armored Vehicles Recognition Handbook](https://maritime.org/doc/id/fm30-40-vehicles/index.htm)  
  Reference guide for identifying older armored vehicles.
- [Combat Vehicle Reference Guide](https://www.inetres.com/gp/military/cv/)  
...
- [Combat Aircraft Recognition Guide](https://www.inetres.com/gp/military/ar/index.html)  
  Guide that shows specific aircraft attributes as well as lists individual aircraft that follows those traits. 
- [Military Aircraft Database](https://www.scramble.nl/database/military)  
  Contains a vast amount of information about different aircraft for air forces in Europe, United States, Canada, South America, Africa, and Asia.
- [AirRecognition](https://www.airrecognition.com/)  
  A neatly organized directory of aircraft and aircraft equipment used by various militaries from all over the world.
...
- [Drone Survival Guide](http://www.dronesurvivalguide.org/)  
  Visual reference to some drones in use by current militaries, including use, as well as some survival information about drones. Entire website archived [here (Wayback)](https://web.archive.org/details/http://www.dronesurvivalguide.org/).
...
- [US Navy Ships](https://fas.org/man/dod-101/sys/ship/index.html)  
...
- [NoFuture Gas Masks](http://nofuture.com/gasmasks.net/)  
...
- [GasMaskLexikon](http://www.gasmasklexikon.com/Page/Start01.htm)  
...
- [CamouflageIndex](https://camouflageindex.camouflagesociety.org/index-2.html)  
  An index of the different types of camouflage used by militaries around the world.
- [Uniform Insignia](https://www.uniforminsignia.org/)  
...
- [ConflictArm Publications](https://www.conflictarm.com/publications/)  
...
- [SIPRI International Arms Embargoes](https://www.sipri.org/databases/embargoes)  
...
- [Mapping Arms Data](http://nisatapps.prio.org/armsglobe/index.php)  
